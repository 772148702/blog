        ...
        <div class="topic panel panel-default">
            <div class="infos panel-heading">
                ...
                <div class="meta inline-block">
                    ...
                    <a class="author" href="${base}/users/${author.id}">
                        ${author.name}
                    </a>
            ...
            <div class="panel-footer operate">
                ...
                <%--<c:forEach items="${post.tagsArray }" var="tag">--%>
                    <%--<span>--%>
...
<script type="text/plain" id="chat_template">
    <li id="chat{5}">
        <a class="avt fl" target="_blank" href="<%=basePath%>users/{0}">
            <img src="<%=basePath%>{1} ">
        </a>
        <div class="chat_body">
            <h5>
                <div class="fl"><a class="chat_name" href="<%=basePath%>users/{0}">{2}</a><span>{3}</span></div>
...
<script type="text/javascript">
    ...
    seajs.use('comment', function (comment) {
        comment.init({
            load_url: '<%=basePath%>comment/list/${post.id}',
            post_url: '<%=basePath%>comment/submit',
            toId: '${post.id}',
